...
- Summarizes the [key details of the Admin API](https://github.com/Purnachndar/exnomy-scaffold-dex/blob/master/manual/admin-api-and-cli.md#admin-api)
- Provides a [guide for CLI functions](https://github.com/Purnachndar/exnomy-scaffold-dex/blob/master/manual/admin-api-and-cli.md#cli-guide-admin-cli)
